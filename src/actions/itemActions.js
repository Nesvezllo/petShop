...
export const getAllPizzas = () => async (dispatch) => {
	...
	try {
		const response = await axios.get(
			'http://45.12.74.190:8080/api/pizzas/getallpizzas',
		);
...
export const addPizza = (pizza) => async (dispatch) => {
	...
	try {
		const response = await axios.post(
			'http://45.12.74.190:8080/api/pizzas/addItem',
			{ pizza: pizza },
		);
		console.log(response);
...
export const getPizzaById = (itemid) => async (dispatch) => {
	...
	try {
		const response = await axios.post(
			'http://45.12.74.190:8080/api/pizzas/getpizzabyid',
			{ itemid: itemid },
		);
		console.log(response);
...
export const updatePizza = (updatedPizza) => async (dispatch) => {
	...
	try {
		const response = await axios.post(
			'http://45.12.74.190:8080/api/pizzas/updatepizza',
...
export const deletePizza = (itemid) => async (dispatch) => {
	...
	try {
		const response = await axios.post(
			'http://45.12.74.190:8080/api/pizzas/deletepizza',
			{ itemid: itemid },
		);
		console.log(response);
